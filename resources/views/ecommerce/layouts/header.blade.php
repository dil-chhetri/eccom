  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="index.html"><span><i class="fa fa-shopping-bag px-2" aria-hidden="true"></i></span>Eccom<span>.</span></a>
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li><a class="nav-link" href="about.html">Categories</a></li>
            ...
            @endif
						<li ><a class="nav-link" href="cart.html"><i class="fa-solid fa-cart-shopping fa-lg"></i><span class="mx-2">Cart</span></a></li>
