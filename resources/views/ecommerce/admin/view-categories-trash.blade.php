                           ...
                           @foreach($categories as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('force.delete.category',['category_id' => $item->category_id ])}}" class="btn btn-danger ">Delete</a>
                                            
                                                
                                                <a href="{{route('restore.category',['category_id' => $item->category_id ])}}" class="btn btn-success ">Restore</a>
