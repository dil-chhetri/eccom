                           ...
                           @foreach($products as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{route('force.delete',['product_id' => $item->product_id ])}}" class="btn btn-danger ">Delete</a>
                                            
                                                
                                                <a href="{{route('restore.product',['product_id' => $item->product_id ])}}" class="btn btn-success ">Restore</a>
